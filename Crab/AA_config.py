...
date = 'Feb26_2023'
config.General.requestName = 'test_'+date+'_AA_{}GeV'.format(mass)
#config.General.requestName = 'test_'+date+'_GJ_pT40toInf_All'
...
config.Data.inputDataset = '/HAHMHToAA_AToGG_MA-{}GeV_TuneCP5_PSweights_13TeV-madgraph_pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM'.format(mass)
#config.Data.inputDataset = '/HAHMHToAA_AToGG_MA-1GeV_TuneCP5_PSweights_13TeV-madgraph_pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM'
...
#config.Data.outLFNDirBase = '/store/user/kypark/PdgId_Test_ATagger_AA_HLT_Iso_Ng2_{}GeV_{}/'.format(mass, date)+date
config.Data.outLFNDirBase = '/store/user/kypark/Updated_ATagger_AA_HLT_Ng2_{}GeV_{}/'.format(mass, date)+date
