...
parser.add_argument('-i', '--infile', default=['test_Nov28_2022_GJ_pT40toInf'], nargs='+', type=str, help='Input root file.')
...
file_loc = '/store/user/kypark/ATagger_GJ_40toInf/Nov28_2022/'
