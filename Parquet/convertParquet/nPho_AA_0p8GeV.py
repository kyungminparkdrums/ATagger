...
parser.add_argument('-i', '--infile', default=['test_Nov29_2022_AA_0p8GeV'], nargs='+', type=str, help='Input root file.')
...
parser.add_argument('-d', '--decay', default='HToAA_MA-0p8GeV', type=str, help='Decay name.')
...
file_loc = '/store/user/kypark/ATagger_AA_0p8GeV/Nov29_2022/'
...
if 'test' not in rhTreeStr[0]:
    ...
    #path, count = complete_path( file_loc + dsetdct[key] + '/ATagger_AA_0p8GeV/' )
