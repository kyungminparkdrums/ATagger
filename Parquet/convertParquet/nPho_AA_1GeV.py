...
parser.add_argument('-i', '--infile', default=['test_Nov28_2022_AA_1GeV'], nargs='+', type=str, help='Input root file.')
...
parser.add_argument('-d', '--decay', default='HToAA_MA-1GeV', type=str, help='Decay name.')
...
file_loc = '/store/user/kypark/ATagger_AA_1GeV/Nov28_2022/'
