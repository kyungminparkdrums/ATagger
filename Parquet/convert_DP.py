...
dir_name = 'Full_ATagger_DP_HLT_Iso_{}'.format(date)
#dir_name = 'ATagger_AA_HLT_Iso_Ng2_Feb25_{}GeV_{}'.format(mass, date)
file_loc = '/store/user/kypark/{}/{}/'.format(dir_name, date)

dsetdct = {
        'DiPhotonJets': 'DiPhotonJets_MGG-80toInf_13TeV_amcatnloFXFX_pythia8'
          }



parser = argparse.ArgumentParser(description='Process some integers.')
parser.add_argument('-i', '--infile', default=['test_{}_DiPhotonJets'.format(date)], nargs='+', type=str, help='Input root file.')
...
parser.add_argument('-o', '--outdir', default='/eos/uscms/store/user/kyungmip/2023_Feb/DP_HLT_Iso/', type=str, help='Output pq file dir.')
#parser.add_argument('-o', '--outdir', default='root://cmseos.fnal.gov//store/user/kyungmip/2023/Parquet/', type=str, help='Output pq file dir.')
#parser.add_argument('-o', '--outdir', default='/eos/uscms/store/user/kyungmip/2023/Parquet/', type=str, help='Output pq file dir.')
parser.add_argument('-d', '--decay', default='DiPhotonJets', type=str, help='Decay name.')
...
if 'test' not in rhTreeStr[0]:
    ...
    #path, count = complete_path( file_loc + dsetdct[key] + '/ATagger_AA_1GeV/' )
    ...
    outlist.remove(path+'/output_40.root')
    outlist.remove(path+'/output_46.root')
