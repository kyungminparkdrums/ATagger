...
dir_name = 'Updated_ATagger_GJ_HLT_Iso_{}'.format(date)
...
parser.add_argument('-i', '--infile', default=['test_{}__GJ_pT40toInf'.format(date)], nargs='+', type=str, help='Input root file.')
...
parser.add_argument('-o', '--outdir', default='/eos/uscms/store/user/kyungmip/2023_Feb/GJ_HLT_Iso/', type=str, help='Output pq file dir.')
...
parser.add_argument('-d', '--decay', default='GJ-pT40toInf', type=str, help='Decay name.')
